  ...
  template: `
    <section class="catalogue-shell">
      <header class="catalogue-header">
        <div>
          <p class="eyebrow">Boutique catalogue</p>
          <h1>Shop sarees</h1>
          <p>Search live products from MongoDB and refine by category, fabric, colour, occasion, price, discount, and stock.</p>
        </div>
      </header>

      <div class="shop-toolbar" aria-label="Shop controls">
        <label class="shop-search">
          <span>Search</span>
          <input [formControl]="search" type="search" placeholder="Search saree, colour, fabric, SKU">
        </label>
        <div class="compact-field">
          <span>Sort</span>
          <details class="custom-select">
            <summary>{{ sortLabel() }}</summary>
            <div class="custom-select-menu" role="listbox" aria-label="Sort products">
        ...
        <div class="shop-results">
          ...
          @if (loading()) {
            ...
            <div class="shop-empty">
              ...
              <h2>Shop products are unavailable</h2>
            ...
            <div class="shop-empty">
              ...
              <h2>No sarees found for these filters</h2>
              <p>Remove a filter or search by fabric, colour, occasion, or product code.</p>
            ...
            <div class="pagination-row" aria-label="Product pagination">
...
export class CataloguePageComponent {
  ...
  private applyResponse(response: PublicProductListResponseDto | null): void {
